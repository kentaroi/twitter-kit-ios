Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/kentaroi/twitter-kit-ios", :branch => "spike" }
  s.prefix_header_file = "TwitterKit/Supporting Files/TwitterKit-Prefix.pch"
  # s.header_dir = "TwitterKit/libextobjc"
  s.source_files = "TwitterKit/*.{h,m}", "TwitterKit/{MoPub,Networking,Persistence,Resources,Social,Supporting Files,TwitterShareExtensionUI}/**/*.{h,m}", "libextobjc/*.h"
